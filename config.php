<?php
	$dbServer = 'localhost';
	$dbUsername = 'u392441939_amigos';
	$dbPassword = 'Timo2195';
	$dbDatabase = 'u392441939_amigos';
	$dbPort = '3306';
	$appURI = 'amigos';
	$host = 'amigos2023.online';

	$adminConfig = [
		'adminUsername' => "jacaraba",
		'adminPassword' => "\$2y\$10\$dIKGcMAdN12OL32mdQa4du2YEoUKGiq0zDlSZcxHMxcWzURDa2Sge",
