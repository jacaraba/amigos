	...
	$lookups = [
		'lideres' => [
			'PUESTO' => [
				...
				'parent_caption' => 'IF(CHAR_LENGTH(`divpol2022`.`PUESTO`) || CHAR_LENGTH(`divpol2022`.`nompue`), CONCAT_WS(\'\', `divpol2022`.`PUESTO`, \'-\', `divpol2022`.`nompue`), \'\')',
				'parent_from' => '`divpol2022` ',
				'filterers' => [],
				'custom_query' => '',
		...
		'municipios' => [
			'dd' => [
				'parent_table' => 'departamentos',
				'parent_pk_field' => 'dd',
				'parent_caption' => 'IF(CHAR_LENGTH(`departamentos`.`dd`) || CHAR_LENGTH(`departamentos`.`departamento`), CONCAT_WS(\'\', `departamentos`.`dd`, \'-\', `departamentos`.`departamento`), \'\')',
				'parent_from' => '`departamentos` ',
				'filterers' => [],
				'custom_query' => 'SELECT `departamentos`.`dd`, IF(CHAR_LENGTH(`departamentos`.`dd`) || CHAR_LENGTH(`departamentos`.`departamento`), CONCAT_WS(\'\', `departamentos`.`dd`, \'-\', `departamentos`.`departamento`), \'\') FROM `departamentos` ORDER BY 2',
				'inherit_permissions' => false,
				'list_type' => 0,
				'not_null' => false,
			],
