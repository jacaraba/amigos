	...
	*/
	...
	function getTableList($skip_authentication = false) {
		...
		$arrTables = [
			...
			'lideres' => ['lideres', '', 'table.gif', 'None'],
			'amigos' => ['Amigos', '', 'table.gif', 'None'],
			'divpol2022' => ['Divpol2022', '', 'table.gif', 'None'],
			'municipios' => ['Municipios', '', 'table.gif', 'None'],
			'departamentos' => ['Departamentos', '', 'table.gif', 'None'],
		];
		...
		if($schema === null) {
			...
			$schema = [
				...
				'amigos' => [
					...
					'LIDER' => [
						'appgini' => "INT NULL DEFAULT '1111111111'",
						'info' => [
							'caption' => 'LIDER',
							'description' => '',
						],
				...
				'divpol2022' => [
					'PUESTO' => [
						'appgini' => "VARCHAR(9) NOT NULL PRIMARY KEY",
						'info' => [
							'caption' => 'PUESTO',
							'description' => '',
						],
				...
				'departamentos' => [
					'dd' => [
						'appgini' => "VARCHAR(2) NOT NULL PRIMARY KEY",
						'info' => [
							'caption' => 'Dd',
							'description' => '',
						],
	...
	function lookupQuery($tn, $lookupField) {
		...
		*/
		$lookupQuery = [
			...
			'municipios' => [
				'dd' => 'SELECT `departamentos`.`dd`, IF(CHAR_LENGTH(`departamentos`.`dd`) || CHAR_LENGTH(`departamentos`.`departamento`), CONCAT_WS(\'\', `departamentos`.`dd`, \'-\', `departamentos`.`departamento`), \'\') FROM `departamentos` ORDER BY 2',
			],
			'departamentos' => [
			],
		];
